...
public enum StoredSelectionPathNormalization {
    ...
    public static func standardizedPaths(_ paths: [String]) -> [String] {
        var seen = Set<String>()
        var result: [String] = []
    ...
    public static func standardizedSlices(_ slices: [String: [LineRange]]) -> [String: [LineRange]] {
...
public enum GitDiffPathNormalization {
    @inline(__always)
    public static func normalizedAbsolutePath(_ path: String) -> String {
        StandardizedPath.absolute(path).precomposedStringWithCanonicalMapping
    }

    public static func normalizedAbsolutePaths(_ paths: [String]) -> [String] {
        paths.map(normalizedAbsolutePath)
    }

    public static func gitRelativePaths(from absolutePaths: [String], repoRootPath: String) -> [String] {
