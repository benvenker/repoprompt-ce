...
public enum RepoPromptRegexRuntime {
    ...
    public static var pcre2SearchMatchLimitsEnabled: Bool {
...
public enum RepoPromptPCRE2MatchPolicy {
    public static var fileSearchFullBuffer: PCRE2MatchLimits? {
...
public enum RepoPromptPCRE2Adapter {
    public static func compile(_ request: RepoPromptPCRE2CompileRequest) throws -> PCRE2Regex {
    ...
    public static func searchPatternError(from error: Error, pattern: String) -> RegexPatternFailure {
    ...
    public static func isVariableLengthLookbehindError(pattern: String, details: String) -> Bool {
    ...
    public static func variableLengthLookbehindSuggestion(pattern: String) -> String? {
    ...
    public static func escapedLiteral(_ literal: String) -> String {
        PCRE2Literal.escapedPattern(for: literal)
    }

    public static func compressDoubleEscapesBeforeMeta(_ pattern: String) -> String {
    ...
    public static func anchoredDeclarationLinePlan(
        for pattern: String,
        caseInsensitive: Bool
    ...
    public static func linePrefilterForAnchoredPattern(
        _ pattern: String,
        caseInsensitive: Bool
    ) -> PCRE2LinePrefilter? {
    ...
    public static func asciiMarkerLinePatternPlan(
    ...
    public static func asciiWholeWordLiteralPlan(
        pattern: String,
        isRegex: Bool,
        wholeWord: Bool,
        caseInsensitive: Bool
    ...
    public static func pathSuffixPattern(forRegex pattern: String) -> PCRE2PathSuffixPattern? {
    ...
    public static func compileSearchRegexWithRepairsResult(
        pattern: String,
        caseInsensitive: Bool,
        wholeWord: Bool,
        multilineAnchors: Bool,
    ...
    public static func compileSearchRegexWithRepairs(
        pattern: String,
        caseInsensitive: Bool,
        wholeWord: Bool,
        multilineAnchors: Bool,
