...
public struct PromptContextAccountingRequest {
    ...
    public let pathLocateProfile: PathLocateProfile
    ...
    public func withFileTree(_ fileTree: TokenCalculationFileTreeInput) -> PromptContextAccountingRequest {
...
public struct PromptContextAccountingResult {
    public let tokenResult: TokenCalculationResult
    public let resolvedEntries: [ResolvedPromptFileEntry]
    public let promptFileEntrySnapshots: [PromptFileEntrySnapshot]
    public let tokenCalculationSnapshot: TokenCalculationSnapshot
    public let missingPaths: [String]
    public let invalidPaths: [String]
    public let codemapSnapshotsUsed: [UUID: WorkspaceCodemapSnapshot]
}
...
public actor PromptContextAccountingService {
    ...
    public init(tokenCalculationService: TokenCalculationService = TokenCalculationService()) {
    ...
    public func makePromptFileEntrySnapshots(
