...
public enum SelectedGitDiffArtifactPolicy {
    case includeBeforeGitInclusion
    case respectGitInclusion
}

public struct PromptContextPreAssemblyRequest {
    public let cfg: PromptContextResolved
    public let selection: StoredSelection
    public let store: WorkspaceFileContextStore
    public let lookupContext: WorkspaceLookupContext
    public let filePathDisplay: FilePathDisplay
    public let onlyIncludeRootsWithSelectedFiles: Bool
    public let includeFileTreeLegend: Bool
    public let showCodeMapMarkers: Bool
    public let codeMapUsage: CodeMapUsage
    public let entryResolutionProfile: PathLocateProfile
    public let selectedGitDiffFolderPolicy: SelectedGitDiffFolderPolicy
    public let selectedGitDiffLookupProfile: PathLocateProfile
    public let includeLocalDefinitionsInFileTree: Bool
    public let selectedGitDiffArtifactPolicy: SelectedGitDiffArtifactPolicy
    public let selectedGitDiffProvider: ([String]) async -> String?
    public let completeGitDiffProvider: () async -> String?
...
public struct PromptContextPreAssemblyResult {
    public let physicalSelection: StoredSelection
    public let entries: [ResolvedPromptFileEntry]
    public let missingPaths: [String]
    public let invalidPaths: [String]
    public let codemapSnapshots: [UUID: WorkspaceCodemapSnapshot]
    public let fileTreeContent: String?
    public let gitDiff: String?
    public let lookupContext: WorkspaceLookupContext
    public let filePathDisplay: FilePathDisplay

    public func displayPath(for entry: ResolvedPromptFileEntry) -> String? {
...
public enum PromptContextPreAssemblyService {
    public static func resolve(_ request: PromptContextPreAssemblyRequest) async -> PromptContextPreAssemblyResult {
