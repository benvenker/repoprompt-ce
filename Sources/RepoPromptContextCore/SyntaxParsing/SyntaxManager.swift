...
public final class SyntaxManager {
    public static let shared = SyntaxManager()
    ...
    public static let parseLineLimit = 25000
    public static let parseUTF16Limit = 1_500_000
    public static let parseUTF8Limit = 5_000_000

    public enum ParseOversizeReason: Equatable, CustomStringConvertible {
    ...
    public let extensionToLanguage: [String: LanguageType] = [
        "swift": .swift,
        "js": .js,
        "cs": .c_sharp,
        "py": .python,
    ...
    public let optimizedQueries: [LanguageType: String] = [
        .swift: swiftQuery,
        .js: javascriptQuery,
        .c_sharp: csharpQuery,
        .python: pythonQuery,
    ...
    public let codeMapQueries: [LanguageType: String] = [
        .c: cCodeMapQuery,
        .cpp: cppCodeMapQuery,
    ...
    public func parsingOversizeReason(for content: String) -> ParseOversizeReason? {
    ...
    private static func languageAndName(for languageType: LanguageType) -> (language: Language?, name: String) {
        ...
        case .php: (Language(language: tree_sitter_php()), "PHP")
        case .ruby: (Language(language: tree_sitter_ruby()), "Ruby")
        }
    }
    ...
    public func languageConfig(forFileExtension ext: String) -> LanguageConfiguration? {
        withTreeSitterExecution {
    ...
    public func parse(content: String, fileExtension: String) throws -> MutableTree? {
    ...
    public func highlight(content: String, fileExtension: String) throws -> [NamedRange] {
    ...
    public func codeMap(content: String, fileExtension: String) throws -> [NamedRange] {
        let pipelineStats = CodeMapPerfRuntime.sharedPipelineStats
    ...
    public static func isSupportedFileExtension(_ fileExt: String) -> Bool {
    ...
    public func supportsCodeMap(fileExtension: String) -> Bool {
