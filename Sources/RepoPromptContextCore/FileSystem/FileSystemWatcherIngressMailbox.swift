...
/// accepted progress.
public final class FileSystemWatcherIngressMailbox: @unchecked Sendable {
    public struct Watermark: Hashable, Comparable {
        public let rawValue: UInt64

        public init(rawValue: UInt64) { self.rawValue = rawValue }

        public static let zero = Watermark(rawValue: 0)
    ...
    public struct AcceptedPayload: @unchecked Sendable {
    ...
    public init(maxQueuedRawEntries: Int) {
    ...
    public func stopAcceptingAndDiscardPending() {
        lock.lock()
        isAccepting = false
    ...
    public func captureAcceptedWatermark() -> Watermark {
        lock.lock()
        defer { lock.unlock() }
    ...
    public func takeNextAcceptedPayload(through target: Watermark? = nil) -> AcceptedPayload? {
        lock.lock()
        defer { lock.unlock() }
