...
public enum TopLevelScanner {
    public struct TrackDelimiters: OptionSet {
        ...
        public static let brace = TrackDelimiters(rawValue: 1 << 2) // { }
        public static let square = TrackDelimiters(rawValue: 1 << 3) // [ ]
        public static let all: TrackDelimiters = [.angle, .paren, .brace, .square]
    }
    ...
    public static func firstTopLevelIndex(
        of char: Character,
        in input: String,
        track: TrackDelimiters = .all
    ) -> String.Index? {
    ...
    public static func firstTopLevelRange(
        of needle: String,
        in input: String,
        track: TrackDelimiters = .all
    ) -> Range<String.Index>? {
    ...
    public static func containsTopLevel(
        _ needle: String,
        in input: String,
        track: TrackDelimiters = .all
    ) -> Bool {
