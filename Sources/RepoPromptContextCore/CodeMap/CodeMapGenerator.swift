...
import Foundation
#if CODEMAP_PERF_SIGNPOSTS && canImport(os)
    import os
#endif
import SwiftTreeSitter

public struct CodeMapGenerator {
    ...
    public static func generateCodeMap(
    ...
    public static func computeLineBoundaries(content: String) -> [Int] {
    ...
    public static func lineNumber(for location: Int, using boundaries: [Int]) -> Int {
