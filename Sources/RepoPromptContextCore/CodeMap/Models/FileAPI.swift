...
public struct TypeAliasInfo: Codable {
    public let name: String
    public let definitionLine: String
}

public struct ClassInfo: Codable {
    public let name: String
    public var methods: [FunctionInfo]
    public var properties: [PropertyInfo]
}
...
public struct VariableInfo: Codable {
    public let name: String
    public let typeName: String?
    public let definitionLine: String
}

public struct EnumInfo: Codable {
    public let name: String
    public var cases: [String]
}

/// Represents a structured "API surface" for a file.
public struct FileAPI: Codable {
    ...
    public var aliases: [TypeAliasInfo]
    public var literalUnions: [String]
    public var functions: [FunctionInfo]
    public var enums: [EnumInfo]
    public var globalVars: [VariableInfo]
    ...
    public let pathAndImportsDescription: String
    public let apiTokenCount: Int
    ...
    public func getFullAPIDescription() -> String {
    ...
    public func getFullAPIDescription(displayPath: String) -> String {
    ...
    public func estimatedFullAPIDescriptionTokens(displayPath: String) -> Int {
