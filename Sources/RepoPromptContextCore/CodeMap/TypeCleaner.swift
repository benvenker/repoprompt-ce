...
public enum TypeCleaner {
    public struct TypeCleanerCacheKey: Hashable {
    ...
    public static func extractBaseTypes(from rawType: String, language: LanguageType) -> [String] {
        switch language {
        case .ts, .tsx:
    ...
    public static func extractBaseTypes(
        from rawType: String,
    ...
    public static func extractBaseTypesNonTS(_ rawType: String, language: LanguageType) -> [String] {
    ...
    public static func extractBaseTypesTS(_ rawType: String, language: LanguageType) -> [String] {
    ...
    public static func filterOutPrimitiveAndSpecialTypes(_ extracted: [String], language: LanguageType) -> [String] {
        var results: [String] = []
    ...
    public static func isGenericPlaceholderTypeName(_ typeName: String, language: LanguageType) -> Bool {
    ...
    public static func isSwiftSpecialTypeName(_ typeName: String) -> Bool {
        isSwiftSpecialType(typeName)
    }

    public static func isPrimitiveType(_ typeName: String, language: LanguageType) -> Bool {
    ...
    public static func isContainerType(_ typeName: String, language: LanguageType) -> Bool {
        let lower = typeName.lowercased()
