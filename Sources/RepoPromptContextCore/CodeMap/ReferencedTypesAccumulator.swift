...
public struct ReferencedTypesAccumulator {
    ...
    public init(language: LanguageType, stats: CodeMapPerfStats? = nil, perfOptions: CodeMapPerfOptions = .disabled) {
    ...
    public func finalizeSorted() -> [String] {
        Array(types).sorted()
    }

    public var rawInsertions: Int {
        rawInsertCount
    }
}
