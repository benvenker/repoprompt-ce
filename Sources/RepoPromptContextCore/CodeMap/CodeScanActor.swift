...
public actor CodeScanActor {
    ...
    public init(maxConcurrentScans: Int = CodeScanActor.defaultMaxConcurrentScans) {
    ...
    #if DEBUG
        public struct CodemapMemoryCounters {
            public let fileAPIEntryCount: Int
            public let latestFileModDateCount: Int
            public let trackedRootCount: Int
            public let trackedFileIDCount: Int
            public let rootKeyByFileIDCount: Int

            public let rootCacheRootCount: Int
            public let rootCacheFileEntryCount: Int
            public let dirtyRootCount: Int
            public let rootCacheLoadTaskCount: Int

            public let rebuildLookupRootCount: Int
            public let rebuildLookupFileEntryCount: Int

            public let queuedCount: Int
            public let activeScanCount: Int
            public let outstandingScanCount: Int
            public let totalScheduledCount: Int
            public let cacheProcessingCount: Int

            public let resultBatchBufferCount: Int
            public let resultBatchBufferFileAPICount: Int

            public let actorRetainedFileAPILikeEntryCount: Int
    ...
    #if DEBUG
        public func codemapMemoryCounters() -> CodemapMemoryCounters {
