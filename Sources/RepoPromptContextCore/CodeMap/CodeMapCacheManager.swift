...
public struct CodeMapContentFingerprint: Codable, Equatable {
    public let contentHash: String
    public let byteCount: Int

    public init(contentHash: String, byteCount: Int) {
...
public struct CodeMapCacheFileEntry: Codable {
    public let modificationDate: Date
    public let contentFingerprint: CodeMapContentFingerprint?
...
public struct CodeMapCacheRootFolder: Codable {
    public var files: [String: CodeMapCacheFileEntry]
}

/// Container to wrap the cache data with a version number.
public struct CodeMapCacheContainer: Codable {
    /// Version of the cached data format.
    public let version: Int
    /// The actual cache data.
    public let rootFolder: CodeMapCacheRootFolder
}

// ============ The Manager ============

public class CodeMapCacheManager {
    ...
    public func loadRootFolderCacheAsync(rootFolderPath: String) async -> CodeMapCacheRootFolder? {
    ...
    public func loadCachedCodeMapAsync(
    ...
    public func removeRootFolder(_ rootFolderPath: String) {
    ...
    public func overwriteRootFolderEntry(rootPath: String, newFilesDict: [String: CodeMapCacheFileEntry]) {
    ...
    public func fetchRootFolderEntry(_ rootFolderPath: String) -> CodeMapCacheRootFolder? {
    ...
    public func unloadCache(forRootFolder rootFolderPath: String) {
        cache.removeValue(forKey: rootFolderPath)
        dirtyRootFolders.remove(rootFolderPath)
    }
