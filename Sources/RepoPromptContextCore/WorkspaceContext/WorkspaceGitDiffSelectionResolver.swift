...
public enum SelectedGitDiffFolderPolicy {
    case filesOnly
    case expandFolders
}

public enum WorkspaceGitDiffSelectionResolver {
    public static func candidates(from selection: StoredSelection) -> [String] {
    ...
    public static func selectedGitDiffPaths(
    ...
    public static func resolveFilesOnlyPaths(
        candidates: [String],
...
extension WorkspaceLookupRootScope {
    public var allowsSelectedGitDiffFilesystemFallback: Bool {
        switch self {
