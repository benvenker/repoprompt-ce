...
public struct WorkspaceSliceSegment: Equatable {
    public let range: LineRange
    public let text: String
}

public struct WorkspaceSliceAssembly: Equatable {
    public let segments: [WorkspaceSliceSegment]
    public let combinedText: String
    public let totalLines: Int
    public let detectedLineEnding: String
    public let usedRanges: [LineRange]
    public let isFullFile: Bool
...
public enum SliceAssemblyBuilder {
    public static func build(from content: String, ranges: [LineRange]?) -> WorkspaceSliceAssembly {
