...
public actor SelectionSliceCoordinator {
    public struct RootScopeRequest {
        public let rootPath: String
        public let scope: PartitionScope

        public init(rootPath: String, scope: PartitionScope) {
            self.rootPath = (rootPath as NSString).standardizingPath
            self.scope = scope
        }

        public init(root: WorkspaceRootRecord, scope: PartitionScope) {
    ...
    public struct SliceUpdate {
        ...
        public let fileModificationTime: Double?
        public let anchors: [SliceAnchor]?
        ...
        public init(file: WorkspaceFileRecord, ranges: [LineRange], anchors: [SliceAnchor]? = nil) {
            self.init(
    ...
    public init(store: PartitionStore = PartitionStore()) {
        self.store = store
    ...
    @discardableResult
    public func applyPartitionUpdates(
        forRootPath rootPath: String,
        scope: PartitionScope,
    ...
    public nonisolated static func buildFileIDProjection(
