...
public enum SliceRangeMath {
    public static func normalize(_ ranges: [LineRange]) -> [LineRange] {
    ...
    public static func coalesce(_ lhs: [LineRange], _ rhs: [LineRange]) -> [LineRange] {
        normalize(lhs + rhs)
    }

    public static func subtract(_ base: [LineRange], removing: [LineRange]) -> [LineRange] {
