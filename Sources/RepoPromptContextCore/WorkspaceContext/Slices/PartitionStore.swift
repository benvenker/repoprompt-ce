...
public struct SliceAnchor: Codable, Equatable {
    public var range: LineRange
    public var startSignature: [String]
    public var endSignature: [String]
...
public actor PartitionStore {
    /// Posted **after** a successful save so other windows/tabs reload in-memory slices.
    public static let didSaveNotification = Notification.Name("RepoPrompt.PartitionStoreDidSave")
    public static let notifRootPathKey = "rootPath"
    public static let notifWorkspaceIDKey = "workspaceID"
    public static let notifTabIDKey = "tabID"
    public static let notifSourceIDKey = "sourceID"
    public nonisolated let notificationSourceID = UUID()
    ...
    public struct StoredSlices: Codable, Equatable {
        public var ranges: [LineRange]
        public var fileModificationTime: Double?
        public var anchors: [SliceAnchor]?
    ...
    public struct PartitionData: Codable {
        var version: Int
    ...
    public func load(forRoot rootPath: String, scope: PartitionScope) async -> PartitionData {
    ...
    public func save(forRoot rootPath: String, scope: PartitionScope, data: PartitionData) async throws {
    ...
    public func load(forRoot rootPath: String, workspaceID: UUID) async -> PartitionData {
        await load(forRoot: rootPath, scope: PartitionScope(workspaceID: workspaceID))
    }

    public func save(forRoot rootPath: String, workspaceID: UUID, data: PartitionData) async throws {
