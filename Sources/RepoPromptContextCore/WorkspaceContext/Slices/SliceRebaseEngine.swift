...
public enum SliceRebaseEngine {
    public struct Result {
        public let rebased: [LineRange]
        public let dropped: [LineRange]
        public let didChange: Bool

        public init(rebased: [LineRange], dropped: [LineRange], didChange: Bool) {
    ...
    public static func buildAnchors(content: String, ranges: [LineRange], maxSignatureLines: Int = 3) -> [SliceAnchor] {
