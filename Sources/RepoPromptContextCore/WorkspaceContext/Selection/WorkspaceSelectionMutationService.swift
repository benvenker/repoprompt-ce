...
public struct WorkspaceSelectionSliceInput: Equatable {
    public let path: String
    public let ranges: [LineRange]

    public init(path: String, ranges: [LineRange]) {
        self.path = path
        self.ranges = ranges
    }
}

public struct WorkspaceBuildSelectionResult: Equatable {
    public let selection: StoredSelection
    public let invalidPaths: [String]
    public let codemapUnavailable: [String]
}

public struct WorkspaceAddSelectionResult: Equatable {
    public let selection: StoredSelection
    public let invalidPaths: [String]
...
public struct WorkspaceRemoveSelectionResult: Equatable {
    public let selection: StoredSelection
    public let invalidPaths: [String]
    public let resolvedMap: [String: String]
    public let mutated: Bool
...
public struct WorkspaceDemoteSelectionResult: Equatable {
    public let selection: StoredSelection
    public let invalidPaths: [String]
    public let codemapUnavailable: [String]
    public let mutated: Bool
...
public struct WorkspaceSliceSelectionMutationResult: Equatable {
    public let selection: StoredSelection
    public let invalidPaths: [String]
    public let resolvedMap: [String: String]
    public let mutated: Bool
...
public struct WorkspaceSelectionMutationService {
    public let store: WorkspaceFileContextStore
    public let codemapsGloballyDisabled: Bool
    public let codemapsGloballyDisabledMessage: String
    ...
    public func buildManageSelectionSet(
        paths: [String],
        slices sliceInputs: [WorkspaceSelectionSliceInput] = [],
        sliceErrors: [String] = [],
        mode: String,
    ...
    public func resolveSelectionCandidates(
        paths: [String],
        rawPaths: [String],
        expandFolders: Bool,
    ...
    public func resolveCodemapOnlyCandidates(
        paths: [String],
        rawPaths: [String],
        expandFolders: Bool,
        rootScope: WorkspaceLookupRootScope = .visibleWorkspace
    ...
    public func recomputeAutoCodemaps(
