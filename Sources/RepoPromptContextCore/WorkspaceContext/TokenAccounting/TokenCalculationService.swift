...
public struct TokenInfo: Identifiable, Equatable {
    public let id = UUID()
    ...
    public init(count: Int, fullCount: Int? = nil, codemapCount: Int = 0, totalTokens: Int) {
        self.count = count
...
public struct TokenCalculationResult {
    public let totalTokenCount: Int
    // NEW – raw integer count of tokens for **files only**
    public let totalTokenCountFilesOnly: Int
    public let fileTokenInfo: [UUID: TokenInfo]
    public let folderTokenInfo: [String: TokenInfo]
    public let tokenCountString: String
    public let tokenCountFilesOnlyString: String
    public let charCount: Int
    public let fileTreeContent: String
    public let fileTreeTokenCount: Double
    public let fileTreeTokenCountRaw: Int
    public let codeMapContent: String // NEW – raw code-map block text
    public let codeMapFileCount: Int
    public let codeMapTokenCount: Int
}

public struct TokenComponentBreakdown {
    ...
    public init(prompt: Int, duplicatePrompt: Int, instructions: Int, fileTree: Int, gitDiff: Int, metadata: Int) {
        self.prompt = prompt
    ...
    public var totalNonFile: Int {
        prompt + duplicatePrompt + instructions + fileTree + gitDiff + metadata
    }
}

public struct PromptEntriesEvaluation {
    ...
    public struct EntryResult {
        ...
        public init(fileID: UUID, renderMode: RenderMode, displayTokens: Int, fullTokens: Int, codemapTokens: Int) {
            self.fileID = fileID
    ...
    public let entryResultsByFileID: [UUID: EntryResult]
    ...
    public static let empty = PromptEntriesEvaluation(
...
public actor TokenCalculationService {
    public init() {}
    ...
    public static func middleTruncate(
        text: String,
        maxTokens: Int,
        marker: String = "\n\n[content truncated]\n\n"
    ) -> String {
    ...
    public static func calculateComponentBreakdown(
        promptText: String,
    ...
    public func evaluatePromptEntries(
    ...
    public func calculatePromptStats(
