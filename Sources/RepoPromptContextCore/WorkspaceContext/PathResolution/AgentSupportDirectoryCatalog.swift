...
public struct AlwaysReadableDirectory: Hashable {
...
public struct AgentSupportGlobalRootURLs {
    public let agentsSkills: URL
    public let agentsSlash: URL
    public let claudeSkills: URL
    public let claudeCommands: URL
    public let codexPrompts: URL
}

public enum AgentSupportDirectoryCatalog {
    public static func globalRootURLs(homeDirectoryURL: URL = FileManager.default.homeDirectoryForCurrentUser) -> AgentSupportGlobalRootURLs {
    ...
    public static func builtInAlwaysReadableDirectories(
    ...
    public static func effectiveAlwaysReadableDirectories(
        homeDirectoryURL: URL = FileManager.default.homeDirectoryForCurrentUser,
    ...
    public static func displayPath(for absolutePath: String, homeDirectoryURL: URL = FileManager.default.homeDirectoryForCurrentUser) -> String {
    ...
    public static func normalizedPath(for path: String) -> String {
