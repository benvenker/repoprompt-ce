...
public enum CreatePathPreflight {
    ...
    public typealias Root = WorkspaceRootRef

    public enum AliasPrefixCheck: Equatable {
        case notPrefixed
    ...
    public struct Result: Equatable {
        ...
        public let aliasCheck: AliasPrefixCheck
        public let isAbsolute: Bool

        public init(normalizedPath: String, aliasCheck: AliasPrefixCheck, isAbsolute: Bool) {
    ...
    public static func checkAliasPrefix(
        _ userPath: String,
        visibleRoots: [Root],
