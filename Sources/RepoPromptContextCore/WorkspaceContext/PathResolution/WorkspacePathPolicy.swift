...
public struct WorkspaceRootRef: Hashable {
    public let id: UUID
    public let name: String
    public let fullPath: String
    public let standardizedFullPath: String

    public init(id: UUID, name: String, fullPath: String) {
        self.id = id
        self.name = name
    ...
    public var compatibilityAlias: String {
        (standardizedFullPath as NSString).lastPathComponent
    }

    public var renderedLabel: String {
        "\(name) → \(fullPath)"
    }
}

public enum RootAliasResolution: Equatable {
...
public struct RootAliasOptions {
    public let requireRemainder: Bool
    public let allowCompatibilityAlias: Bool
    ...
    public let disambiguateRealSubpath: Bool
...
public enum WorkspaceAliasResolver {
...
public enum PathResolutionIssue: Equatable {
    case emptyInput
...
public enum PathResolutionIssueRenderer {
    public static func message(for issue: PathResolutionIssue) -> String {
        switch issue {
        case .emptyInput:
...
public enum ClientPathFormatter {
    ...
    public static func displayAbsolutePath(
        fullPath: String,
        visibleRoots: [WorkspaceRootRef]
    ) -> String {
