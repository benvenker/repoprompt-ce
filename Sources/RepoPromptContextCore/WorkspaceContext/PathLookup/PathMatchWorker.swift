...
public struct SelectionSig: Equatable {
    let count: Int
    public let hash: UInt64

    public static let empty = SelectionSig(count: 0, hash: 0)
}
...
public actor PathMatchWorker {
    ...
    @discardableResult
    public func prepare(staticData: StaticPathMatchData) -> UInt64 {
