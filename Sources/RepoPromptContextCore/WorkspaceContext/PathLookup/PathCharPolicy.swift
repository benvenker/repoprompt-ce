...
public enum PathCharPolicy {
    @inline(__always)
    public static func isAllowedASCIIByte(_ b: UInt8) -> Bool {
        switch b {
        case 0x30 ... 0x39, // 0-9
             0x41 ... 0x5A, // A-Z
             0x61 ... 0x7A, // a-z
    ...
    @inline(__always)
    public static func toLowerASCII(_ b: UInt8) -> UInt8 {
    ...
    @inline(__always)
    public static func isZeroWidthOrFormat(_ sc: UnicodeScalar) -> Bool {
        switch sc.value {
    ...
    @inline(__always)
    public static func emitFolded(_ sc: UnicodeScalar, into view: inout String.UnicodeScalarView) {
        let v = sc.value
    ...
    public static func foldHomoglyphsIfNeeded(_ s: String) -> String {
