...
public struct WorkspaceSearchContentCacheKey: Hashable {
    public let rootID: UUID
    public let fileID: UUID
    public let standardizedRelativePath: String
}

public struct WorkspaceSearchDecodedContentEntry {
...
public actor WorkspaceSearchDecodedContentCache {
    #if DEBUG
        public struct Snapshot: Equatable {
            ...
            public let acceptedLoadCount: Int
            public let latestRevision: UInt64
        }
    #endif
    ...
    public init(maxEntryCount: Int = 4096, maxEstimatedCost: Int = 128 * 1024 * 1024) {
    ...
    public func invalidate(_ key: WorkspaceSearchContentCacheKey, through invalidationEpoch: UInt64) {
    ...
    public func invalidate(rootID: UUID) {
