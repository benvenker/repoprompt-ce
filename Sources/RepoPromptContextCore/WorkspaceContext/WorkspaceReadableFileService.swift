...
public struct WorkspaceReadableFileService {
    ...
    public func awaitFreshnessForExplicitRequest(
        _ userPath: String,
    ...
    public static func exactAbsoluteCatalogHitInput(_ rawPath: String) -> String? {
    ...
    public func resolveExactAbsoluteWorkspaceCatalogHit(
        _ rawPath: String,
    ...
    public func resolveExactWorkspaceCatalogHit(
        _ rawPath: String,
        rootScope: WorkspaceLookupRootScope
    ) async -> WorkspaceFileRecord? {
    ...
    public func resolveReadableFile(
        _ userPath: String,
    ...
    public func resolveAlwaysReadableExternalFolderDisplayPath(_ userPath: String) -> String? {
    ...
    public func displayPath(forExternalPath userPath: String) -> String {
        AgentSupportDirectoryCatalog.displayPath(for: normalizedInput(userPath), homeDirectoryURL: homeDirectoryURL)
    }

    public func isAlwaysReadableExternalPath(_ userPath: String) -> Bool {
        let normalized = normalizedInput(userPath)
    ...
    public func readAlwaysReadableExternalFile(_ file: WorkspaceExternalReadableFile) async throws -> String {
    ...
    public func resolveAlwaysReadableExternalFile(atAbsolutePath path: String) -> WorkspaceExternalReadableFile? {
