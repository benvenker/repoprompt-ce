...
public actor WorkspaceSearchService {
    ...
    public init(automaticIndexBuildDelayNanoseconds: UInt64 = 0) {
    ...
    public var indexedGeneration: UInt64? {
    ...
    public var diagnostics: WorkspaceCatalogDiagnostics? {
        currentDiagnostics
    }

    public var indexedPathCount: Int {
        indexedPaths.count
    }
    ...
    public var observedCatalogGeneration: UInt64? {
        latestObservedCatalogGeneration
    }

    public var discardedStaleRebuildCount: Int {
        discardedAutomaticRebuildCompletions
    }

    public func startKeepingFresh(
    ...
    @discardableResult
    public func rebuildIndex(from snapshot: WorkspaceSearchCatalogSnapshot) async -> UInt64 {
        rebuildSerial &+= 1
    ...
    @discardableResult
    public func prepareIndex(from snapshot: WorkspaceSearchCatalogSnapshot) async -> UInt64 {
    ...
    public func search(_ query: String, limit: Int = 300) async -> WorkspaceSearchQueryResult {
