...
public enum BroadSearchAdmissionClass: String {
    case unscopedContent
    case unscopedBoth
}

public enum StoreBackedWorkspaceSearchAdmissionError: LocalizedError, Equatable {
    public enum QueueScope: String {
        case perStore
    }
...
public actor StoreBackedWorkspaceSearchLane {
    public struct Configuration: Equatable {
        ...
        public let maxQueueWait: Duration
        public let retryAfterMilliseconds: Int

        public var maxQueueWaitMilliseconds: Int {
        ...
        public init(maxQueueWait: Duration, retryAfterMilliseconds: Int = 1000) {
    ...
    public struct AdmissionClock {
        public static func continuous() -> AdmissionClock {
        ...
        public let sleepUntil: @Sendable (_ deadline: Duration) async throws -> Void
    }
        ...
        public struct Snapshot: Equatable {
            ...
            public let waitExpiryCount: Int
            public let queuedCancellationCount: Int
            public let maximumActivePermitCount: Int
            public let maximumWaiterCount: Int
        ...
        public enum DebugConfigurationUpdateResult: Equatable {
    ...
    public func withSearchAccess<T>(
    ...
    private static func queueAgeBucket(milliseconds: Int) -> String {
        ...
        public func configureForTesting(_ newConfiguration: Configuration) -> DebugConfigurationUpdateResult {
        ...
        public func resetConfigurationForTesting() -> DebugConfigurationUpdateResult {
