...
public struct SearchMatch: Hashable, Codable {
    ...
    public let lineText: String // original text (no newline)
    public let contextBefore: [String]? // Lines before the match (when contextLines > 0)
    public let contextAfter: [String]? // Lines after the match (when contextLines > 0)

    public init(filePath: String, lineNumber: Int, lineText: String, contextBefore: [String]? = nil, contextAfter: [String]? = nil) {
...
public struct SearchOptions {
    ...
    public var fuzzySpaceMatching: Bool
    public var allowLiteralUnescapeFallback: Bool
    public var contentFreshnessPolicy: FileContentFreshnessPolicy
...
public struct PatternErrorInfo: Codable {
    public let errorType: String
    public let description: String

    public init(_ error: RegexPatternFailure) {
...
public struct PerFileError: Codable {
    public let filePath: String
    public let error: PatternErrorInfo

    public init(filePath: String, error: RegexPatternFailure) {
        self.filePath = filePath
...
public struct SearchResults: Codable {
    ...
    public var contentFileCount: Int?
    ...
    public var scopedFileCount: Int?
    /// Error that occurred during path search phase
    public var pathError: PatternErrorInfo?
    /// Error that occurred during content search phase
    public var contentError: PatternErrorInfo?
    /// Per-file errors that occurred during scanning
    public var perFileErrors: [PerFileError]?
...
public struct SearchFileDescriptor {
    ...
    public let standardizedRootFolderPath: String
    public let fileExtension: String?
    public let contentSnapshot: (FileContentFreshnessPolicy) async throws -> FileSearchContentSnapshot
...
public struct OrderedSearchBatchWindow {
    ...
    public let maxEnqueueLead: Int
    private(set) var nextBatchToEnqueue = 0
    private(set) var nextBatchToDrain = 0

    public init(batchCount: Int, maxEnqueueLead: Int) {
...
public actor FileSearchActor {
    ...
    public static func contentScanBatchSize(fileCount: Int, workerCount: Int) -> Int {
    ...
    public static func inferredAutoMode(_ raw: String) -> SearchMode {
    ...
    public static func containsRegexSyntax(_ pattern: String) -> Bool {
