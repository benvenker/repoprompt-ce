...
public enum SearchPathClause: Equatable {
...
public struct SearchPathFilterSpec: Equatable {
    public let caseInsensitive: Bool
    public let clauses: [SearchPathClause]

    public init(caseInsensitive: Bool, clauses: [SearchPathClause]) {
        self.caseInsensitive = caseInsensitive
        self.clauses = clauses
    }
}

public struct FileSearchPathSnapshot {
...
public struct FileSearchPathFilterResult: Equatable {
    public let matchedFullPaths: [String]
    public let visitedSnapshotCount: Int
    public let cancelled: Bool

    public init(matchedFullPaths: [String], visitedSnapshotCount: Int, cancelled: Bool) {
        self.matchedFullPaths = matchedFullPaths
...
public struct FileSearchPathIndexFilterResult: Equatable {
    public let matchedSnapshotIndices: [Int]
    public let visitedSnapshotCount: Int
    public let cancelled: Bool

    public init(matchedSnapshotIndices: [Int], visitedSnapshotCount: Int, cancelled: Bool) {
...
public func filterPathIndicesResult(
    snapshots: [FileSearchPathSnapshot],
    spec: SearchPathFilterSpec
...
@inline(__always)
public func normalizedFolderSuffixFragment(_ fragment: String, caseInsensitive: Bool = true) -> String? {
...
public struct SearchFolderSuffixIndexEntry<T> {
    let folder: T
    let normalizedRelativePath: String
}

public typealias SearchFolderSuffixIndex<T> = [String: [SearchFolderSuffixIndexEntry<T>]]

public func buildFolderSuffixIndex<T>(
...
public func resolveFoldersBySuffixFragment<T>(
    _ fragment: String,
