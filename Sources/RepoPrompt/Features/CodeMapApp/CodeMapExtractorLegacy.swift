...
extension CodeMapExtractor {
    ...
    struct LegacyRootInfo: Hashable {
    ...
    static func buildLocalDefinitionBlockIfNeeded(
        ...
        buildLocalDefinitionBlockIfNeeded(
            ...
            filePathDisplay: filePathDisplay,
            roots: codeMapLegacyRootInfos(from: rootFolders)
        )
    }
    ...
    @inline(__always)
    private static func codeMapLegacyRootInfos(from rootFolders: [FolderViewModel]) -> [LegacyRootInfo] {
        rootFolders.map {
            LegacyRootInfo(
    ...
    private static func isUnderCurrentRoots(_ standardizedPath: String, roots: [LegacyRootInfo]) -> Bool {
    ...
    private static func filterAPIsToCurrentRoots(_ apis: [FileAPI], rootFolders: [FolderViewModel]) -> [FileAPI] {
        filterAPIsToCurrentRoots(apis, roots: codeMapLegacyRootInfos(from: rootFolders))
    }

    private static func filterAPIsToCurrentRoots(_ apis: [FileAPI], roots: [LegacyRootInfo]) -> [FileAPI] {
    ...
    static func getCodeMapFilePaths(
        ...
        let rootInfos = codeMapLegacyRootInfos(from: rootFolders)
    ...
    static func generateFileTreeForSubsetFiles(
        ...
        let roots = codeMapLegacyRootInfos(from: rootFolders)
