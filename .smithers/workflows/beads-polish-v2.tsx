...
// smithers-display-name: Beads Polish v2
// smithers-description: Polish selected Beads with compact bead-local lanes, serialized per-bead apply, and explicit better-beads skill use.
// smithers-tags: beads, planning, review, polish
/** @jsxImportSource smithers-orchestrator */
import { createSmithers } from "smithers-orchestrator";
import { z } from "zod/v4";
import { agents } from "../agents";
import ReviewPrompt from "../prompts/beads-polish-v2-review.mdx";
import SynthesizePrompt from "../prompts/beads-polish-v2-synthesize.mdx";
import ApplyPrompt from "../prompts/beads-polish-v2-apply.mdx";
import FinalPrompt from "../prompts/beads-polish-v2-final.mdx";
...
function reviewAgentsFor(count: number) {
  ...
  if (pool.length === 0) {
    throw new Error("beads-polish-v2 requires at least one configured polish agent.");
  }
